...
function B2bServicePage() {
    return (
        <section className=' pb-14'>
            <B2bHerosection />
            <div className={`${sectionPadding} flex flex-col md:flex-row text-[#211D1D] justify-between gap-5 md:gap-14 pt-8 pb-10 md:pt-0`}>
                <motion.div
                    ...
                    <h2 className='text-[#211D1D] font-bold text-[40px] leading-10 mb-3'>B2B SERVICES </h2>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, ease: easeOutExpo }}
                    className="w-full flex justify-center h-[340px]">
                    <Image
                        src={images.b2b_img}
                        alt="book a repair"
