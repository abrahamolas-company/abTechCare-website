      ...
      <div className={`${sectionPadding} relative z-10`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[25px]">
          {services.map((service, index) => (
            ...
            className="bg-[#FFCC2917] text-[#211D1D] p-5 rounded-lg shadow-lg" key={index}>
              <span className='w-[40px] h-[40px] mb-[6px] rounded-full bg-[#FFCC29] flex items-center justify-center'><service.icon /></span>
