                ...
                <div className='flex flex-col gap-14 z-10 relative md:flex-row md:justify-between'>
                    <div className='text-white md:w-1/2'>
                        ...
                        <div className='flex items-center gap-5'>
                            <Link href="/quote" className='bg-[#FFCC29] rounded-[10px] text-[#211D1D] py-3 px-10 transition-all ease-in-out duration-300 border border-[#FFCC29] hover:bg-transparent hover:text-white'>Get a quote</Link>
                            <button onClick={() => setIsPickupAndDeliveryModalOpen(true)} className='border border-[#FFCC29] rounded-[10px] text-white py-3 px-10 hover:bg-[#FFCC29] hover:text-[#211D1D] transition-all ease-in-out duration-300'>Pickup and Delivery</button>
                        </div>
                    </div>
                </div>
            </section>
