...
export const ComponentLoader: FunctionComponent<ComponentLoaderProps> = (
    ...
    return (
        <div className={`w-16 h-16 border-4 border-ga-green-dark2 border-t-transparent border-solid rounded-full animate-spin ${className}`} />
    );
}
...
export const ButtonLoader: FunctionComponent<ComponentLoaderProps> = (
    ...
    return (
        <div className='absolute w-full h-full top-0 left-0 bg-gagborder-ga-green-dark2 grid place-items-center pointer-events-none'>
...
export const FullPageLoader: FunctionComponent<FullPageLoaderProps> = (
    ...
    return (
        <div className={`h-52 w-full grid place-items-center ${containerClassName}`}>
            <div className={`w-12 h-12 border-4 border-ga-green-dark2 border-t-transparent border-solid rounded-full animate-spin ${className}`} />
        </div>
    );
}