    ...
    return (
        <div className='mt-16 mb-14 w-1/2 mx-auto'>
            <div className='bg-white shadow-md rounded-[10px] w-full py-6 px-5'>
              ...
              <button type='button' className="bg-[#FFCC29] font-medium !mt-5 mb-4 flex items-center justify-center ml-auto text-sm rounded-lg text-[#211D1D] py-3 px-10 transition-all ease-in-out duration-300 border border-[#FFCC29] hover:bg-transparent hover:text-[#211D1D]">
            Rate
          </button>
        </div>
